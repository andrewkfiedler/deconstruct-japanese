...
var KuromojiAnalyzer = _interopDefault(require('kuroshiro-analyzer-kuromoji'));
var Kuroshiro = _interopDefault(require('kuroshiro'));
...
function extractFurigana(text) {
  return kuroshiro.init(analyzer).then(() => {
    return kuroshiro.convert(text, {mode: 'furigana'})
